    ...
    for dna in range(POP_SIZE):
        for dupl in j_d:
            ...
            if len(fidx) >= 2 and frets[fidx[0]] > frets[fidx[1]]:
                ...
                if frets[fidx[0]] > frets[fidx[2]]:
                    f[dna] = f[dna] + 1000
                elif frets[fidx[1]] > frets[fidx[2]]:
                    f[dna] = f[dna] + 1000
            elif len(fidx) == 4:
                if frets[fidx[0]] > frets[fidx[3]]:
                    f[dna] = f[dna] + 1000
                elif frets[fidx[1]] > frets[fidx[3]]:
                    f[dna] = f[dna] + 1000
                elif frets[fidx[2]] > frets[fidx[3]]:
                    f[dna] = f[dna] + 1000
            ...
            if len(fidx) >= 2 and frets[fidx[0]] == frets[fidx[1]] and index[fidx[0]][1] < index[fidx[1]][1]:
                ...
                if frets[fidx[1]] == frets[fidx[2]] and index[fidx[1]][1] < index[fidx[2]][1]:
                    ...
                    f[dna] = f[dna] + 1000
                    #print(frets[fidx[0]], ' ==? ', frets[fidx[2]], 'finger1: ', fidx[0],'/',index[fidx[0]][1],' finger2: ', fidx[2],'/',index[fidx[2]][1])
            elif len(fidx) == 4:
